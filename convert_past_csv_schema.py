...
colums_to_drop_1 = past_data.iloc[:,old_otherServices_st_index:new_otherSverices_ed_index].columns
colums_to_drop_2 = past_data.iloc[:,old_response_st_index:old_response_ed_index].columns
...
past_data.drop(columns=["Form - Primary Incident Type","Form - Secondary Incident Type"],inplace=True)   
