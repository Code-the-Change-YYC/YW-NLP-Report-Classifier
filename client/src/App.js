...
function App() {
    ...
    const checkImmediateResponse = () =>
        setImmediateResponse(
            autocompleteMultipleOptions(immediateResponseOptions)
        )
        ...
        <div className='App'>
            ...
            <form>
                ...
                <FormRow style={{ flexDirection: 'row' }}>
                    <div style={{ width: '100%' }}>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setStaffInvolvedFirst(e.target.value)
                            }
                            style={{ width: '95%' }}
                        ></Input>
                    </div>
                    <div style={{ width: '100%' }}>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setStaffInvolvedLast(e.target.value)
                            }
                        ></Input>
                    </div>
                </FormRow>
                ...
                >
                    ...
                    <div style={{ width: '100%' }}>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setOtherSecIncidentType(e.target.value)
                            }
                        ></Input>
                    </div>
                </FormRow>
                <FormRow style={{ flexDirection: 'row' }}>
                    ...
                    <div style={{ width: '100%' }}>
                        <label>
                            Did this incident involve a non-client guest?
                        </label>
                        <Select
                ...
                <FormRow style={{ flexDirection: 'row' }}>
                    ...
                    <div style={{ width: '100%' }}>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setSupervisorReviewer(e.target.value)
                            }
                        ></Input>
                    </div>
                </FormRow>
